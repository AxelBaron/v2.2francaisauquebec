...
<?php include '../inc/header.php'; ?>
    ...
    <div class="demo">
        <div class="container">
            <h2 class="demo__title">.here your module/composant name</h2>
            <div class="demo__intro">here your module/composant description</div>
            <div class="demo__content">
                ...
                <div class="demo__item demo__item--big">
                    ...
                    <p>put here html module/componant</p>
                </div>
            </div>
